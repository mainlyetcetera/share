function solve(array) {
  ...
  array.forEach(function(element) {
    if (countsObj[element] === undefined) {
      countsObj[element] = 1;
    } else {
      countsObj[element]++;
    }
  ...
  // }
  var result = [];
  currFreqArr.forEach(function(element) {
    array.forEach(function(origElement) {
      return Number(element) === origElement ? result.push(origElement) : result;
    });
  });
  return result;
}
